        ...
        <div className='container sm:flex justify-between items-center'>
            ...
            <div className='hidden lg:flex text-gray-500 text-[30px] gap-4'>
                ...
                <div className='relative'>
                    <FiHeart />
                    <div className='bg-red-600 rounded-full absolute top-0 right-0 w-[18px] h-[18px] text-[12px] text-white grid place-items-center translate-x-1 translate-y-[-.25rem]'>0</div>
                </div>
